...
pub trait UnityGraphicsD3D12V2Ext {
...
macro_rules! impl_d3d12_v2 {
    ($intf:ty) => {
        impl UnityGraphicsD3D12V2Ext for $intf {
            unsafe fn device(&self) -> ComPtr {
...
pub trait UnityGraphicsD3D12Ext: UnityGraphicsD3D12V2Ext {
...
macro_rules! impl_d3d12 {
    ($intf:ty) => {
        ...
        impl UnityGraphicsD3D12Ext for $intf {
            unsafe fn command_queue(&self) -> ComPtr {
...
pub trait UnityGraphicsD3D12v3Ext: UnityGraphicsD3D12V2Ext {
...
macro_rules! impl_d3d12_v3 {
    ($intf:ty) => {
        ...
        impl UnityGraphicsD3D12v3Ext for $intf {
...
pub trait UnityGraphicsD3D12v4Ext: UnityGraphicsD3D12v3Ext {
    unsafe fn command_queue(&self) -> ComPtr;
}
...
macro_rules! impl_d3d12_v4 {
    ($intf:ty) => {
        ...
        impl UnityGraphicsD3D12v4Ext for $intf {
            unsafe fn command_queue(&self) -> ComPtr {
                unsafe { self.interface().GetCommandQueue.expect("GetCommandQueue")() as ComPtr }
            }
        }
...
pub trait UnityGraphicsD3D12v5Ext: UnityGraphicsD3D12v4Ext {
...
macro_rules! impl_d3d12_v5 {
    ($intf:ty) => {
        ...
        impl UnityGraphicsD3D12v5Ext for $intf {
            unsafe fn texture_from_render_buffer(&self, rb: graphics::RenderBuffer) -> ComPtr {
                unsafe {
                    self.interface()
...
pub trait UnityGraphicsD3D12v6Ext: UnityGraphicsD3D12v5Ext {
...
macro_rules! impl_d3d12_v6 {
    ($intf:ty) => {
        ...
        impl UnityGraphicsD3D12v6Ext for $intf {
            fn configure_event(&self, event_id: i32, plugin_event_config: &PluginEventConfig) {
                unsafe {
...
pub trait UnityGraphicsD3D12v7Ext: UnityGraphicsD3D12v6Ext {
...
macro_rules! impl_d3d12_v7 {
    ($intf:ty) => {
        ...
        impl UnityGraphicsD3D12v7Ext for $intf {
            unsafe fn swap_chain(&self) -> ComPtr {
...
pub trait UnityGraphicsD3D12v8Ext: UnityGraphicsD3D12v7Ext {
...
macro_rules! impl_d3d12_v8 {
    ($intf:ty) => {
        ...
        impl UnityGraphicsD3D12v8Ext for $intf {
            fn request_resource_state(&self, resource: ComPtr, state: i32) {
                unsafe {
                    self.interface()
